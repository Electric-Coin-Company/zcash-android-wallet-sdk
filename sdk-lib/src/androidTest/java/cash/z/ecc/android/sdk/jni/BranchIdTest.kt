...
class BranchIdTest internal constructor(
    ...
    companion object {
        ...
        fun wallets(): List<Array<Any>> {
            ...
            return listOf(
                // Mainnet Cases
                arrayOf("Sapling", BlockHeight(419_200), 1991772603L, "76b809bb", mainnetBackend),
                arrayOf("Blossom", BlockHeight(653_600), 733220448L, "2bb40e60", mainnetBackend),
                arrayOf("Heartwood", BlockHeight(903_000), 4122551051L, "f5b9230b", mainnetBackend),
                arrayOf("Canopy", BlockHeight(1_046_400), 3925833126L, "e9ff75a6", mainnetBackend),

                // Testnet Cases
                arrayOf("Sapling", BlockHeight(280_000), 1991772603L, "76b809bb", testnetBackend),
                arrayOf("Blossom", BlockHeight(584_000), 733220448L, "2bb40e60", testnetBackend),
                arrayOf("Heartwood", BlockHeight(903_800), 4122551051L, "f5b9230b", testnetBackend),
                arrayOf("Canopy", BlockHeight(1_028_500), 3925833126L, "e9ff75a6", testnetBackend)
            )
        }
    }
}
