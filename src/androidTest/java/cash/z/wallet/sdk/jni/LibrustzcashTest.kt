...
class LibrustzcashTest {
    ...
    @Test
    fun testScanBlocks() {
        librustzcash.initDataDb(dbDataFile)
        librustzcash.initAccountsTable(dbDataFile, "dummyseed".toByteArray(), 1)
        ...
        val result = librustzcash.scanBlocks(
